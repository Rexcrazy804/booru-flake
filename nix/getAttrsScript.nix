...
''
  ...
  def main [...ids: string] {
    for $id in $ids {
      ...
      let only = "?only=id,created_at,uploader_id,source,md5,rating,image_width,image_height,tag_string,file_ext,file_size,pixiv_id,tag_string_general,tag_string_character,tag_string_copyright,tag_string_artist,tag_string_meta,file_url,large_file_url,preview_file_url"
